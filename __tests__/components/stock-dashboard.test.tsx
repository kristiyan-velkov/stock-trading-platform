...
jest.mock("@/components/watchlist-sidebar", () => ({
  WatchlistSidebar: () => <div data-testid="watchlist-sidebar">Watchlist Sidebar</div>,
}))

jest.mock("@/components/portfolio-table", () => ({
  PortfolioTable: () => <div data-testid="portfolio-table">Portfolio Table</div>,
}))
...
jest.mock("@/components/trading-view-chart", () => ({
  TradingViewChart: () => <div data-testid="trading-view-chart">TradingView Chart</div>,
}))
